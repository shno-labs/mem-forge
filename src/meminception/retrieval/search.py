"""Hybrid search engine for MemInception.
...
from meminception.memory.lifecycle import allowed_search_statuses
from meminception.models import Memory, SearchResult
from meminception.retrieval.embeddings import EmbeddingCache, embed_texts
from meminception.retrieval.query_analyzer import QueryAnalysis, analyze_query
            ...
            try:
                ...
                if mem_sources:
                    ...
                    if doc:
                        ...
                        file_uri = doc.normalized_content_uri
