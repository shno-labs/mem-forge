...
from meminception.models import AgentHookReceipt, AgentSessionReceipt, content_hash, slugify
...
"""
    ...
    return f"""You are generating a durable agent-session source package for MemInception.
