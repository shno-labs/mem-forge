...
from meminception.models import GeneMetadata
...
def _register_builtins() -> None:
    ...
    builtin_imports: list[tuple[str, str, str]] = [
        ...
        ("agent_session", "meminception.genes.agent_session_gene", "AgentSessionGene"),
        ("confluence", "meminception.genes.confluence_gene", "ConfluenceGene"),
        ("github_pages", "meminception.genes.github_pages_gene", "GitHubPagesGene"),
        ("jira", "meminception.genes.jira_gene", "JiraGene"),
        ("teams", "meminception.genes.teams_gene", "TeamsGene"),
    ]
