"""Gene Sync Orchestrator — the heart of MemInception's data pipeline.
...
from meminception.pipeline.document_units import ExtractionContextPacker, UnitizationPolicy, unitize_markdown
from meminception.pipeline.document_update import DocumentUpdatePlan, plan_document_update
from meminception.memory.index_payloads import (
...
if TYPE_CHECKING:
    ...
    from meminception.models import ContentItem, Memory
...
class GeneSyncOrchestrator:
    ...
    async def _upsert_document_embedding(
        ...
        try:
            from meminception.retrieval.embeddings import embed_texts
