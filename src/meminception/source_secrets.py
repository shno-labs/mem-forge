...
SECRET_KEY_ENV = "MEMINCEPTION_SECRET_KEY"
SECRET_KEY_FILE_ENV = "MEMINCEPTION_SECRET_KEY_FILE"
ENCRYPTED_PREFIX = "enc:v1:"
SOURCE_SECRET_FIELDS = ("pat",)
DEFAULT_KEY_PATH = Path.home() / ".meminception" / "secrets" / "source-secrets.key"
...
def _key_path() -> Path:
    ...
    base_dir = os.environ.get("MEMINCEPTION_BASE_DIR", "").strip()
    if base_dir:
