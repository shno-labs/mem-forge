...
from meminception.memory.lifecycle import allowed_search_statuses, normalize_memory_status
...
class Database:
    """Async SQLite database layer for MemInception."""
    ...
    async def update_memory_content(
        ...
        async with self._write_lock:
            from meminception.models import content_hash
