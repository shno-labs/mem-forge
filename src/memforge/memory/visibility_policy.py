...
source defaults to workspace with no owner. Direct in-process callers that do not
have a request principal fall back to LOCAL_DEV_USER_ID so a private memory
always carries a non-empty owner.
"""
