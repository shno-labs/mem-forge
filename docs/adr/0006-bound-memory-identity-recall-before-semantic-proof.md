...
Evidence even when an equivalent Memory already exists. Existing-Memory context
is comparison input for phrasing and change interpretation, never a novelty
filter. Reconciliation owns Memory-ID reuse and Support attachment. This keeps a
copied, moved, independently sourced, or newly in-scope Source Unit from losing
lineage merely because its claim was already known, without introducing a
replay ledger or provider-specific lifecycle branch.
