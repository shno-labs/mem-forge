...
def test_push_github_repo_document_posts_adapter_payload():
    ...
    result = client.push_github_repo_document(
        ...
        symlink_chain=[{
            "path": "docs/design.md",
            "blob_sha": "link-1",
            "target_path": "docs/current-design.md",
        }],
        resolved_relative_path="docs/current-design.md",
...
def test_push_teams_window_package_posts_raw_payload_without_markdown_body():
    ...
    result = client.push_teams_window_package(
        ...
        artifact_source_unit_key="teams-thread:src-teams:conv:root",
        artifact_input_hashes=["a" * 64],
        submitted_by="codex",
