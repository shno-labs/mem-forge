...
function AccountFooter() {
  ...
  // Standalone: the sidebar already names the install at the top via Brand,
  // so the footer slot stays empty until an extension fills it. We
  // deliberately do not invent a second identity card here.
  return null;
}
